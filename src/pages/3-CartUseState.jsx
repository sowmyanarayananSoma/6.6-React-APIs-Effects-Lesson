...
export default function CartUseState() {
  ...
  // Notice: every action requires multiple coordinated setter calls
  // If you forget one, the state falls out of sync silently
  ...
  function handleApplyDiscount(amount) {
    setDiscount(amount);
    setTotalPrice(totalPrice * (1 - amount / 100));
  }
  ...
  if (isCheckingOut) {
    return (
      <div style={styles.success}>
        ...
        <p style={{ color: "#888", marginBottom: "24px" }}>Total paid: ${totalPrice.toFixed(2)}</p>
  ...
  return (
    <div style={styles.page}>
      ...
      <p style={styles.subheading}>useState — 5 separate state variables</p>
